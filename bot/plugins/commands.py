...
async def start(bot, update):
    ...
    if update_channel:
        try:
            ...
            #await update.reply_text(f"Join @{newmoviesottrelease} To Use Me")
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton
                                (
                                    '👨‍💼 𝙳𝚎𝚟𝚎𝚕𝚘𝚙𝚎𝚛𝚜 👨‍💼', url="https://t.me/newmoviesottrelease"
                                )
                        ]
                    ]
                )
